...
const i18n = {
    zh: {
        ...
        'method.train.rl.pacore': 'PaCoRe Training：500 次迭代（上下文长度：64K 最大序列）。',
        'footer.cta.title': '开始体验',
        'footer.cta.desc': '申请接入、联系合作或了解更多合规与试用流程。',
        'footer.cta.apply': '申请接入',
        'footer.cta.contact': '联系我们',
    ...
    en: {
        ...
        'table.model': 'Model',
        'showcase.intro': 'Showcase highlights real cases powered by Step3-VL-10B: Case 1 walks through Morse-code reasoning from a table, followed by voice control, GUI automation, and deep research workflows.',
        ...
        'method.train.rl.pacore': 'PaCoRe Training: 500 iterations (Context length: 64K max sequence).',
        'footer.cta.title': 'Get Started',
        'footer.cta.desc': 'Apply for access, contact for collaboration, or learn about compliance and trial process.',
        'footer.cta.apply': 'Apply for Access',
        'footer.cta.contact': 'Contact Us',
